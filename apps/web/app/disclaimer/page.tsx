...
export default function DisclaimerPage() {
  return (
    <LegalPage title="Disclaimer" intro="PowerPay is a transaction interface for Solana and PWRC. Market information and interface estimates should not be treated as financial, investment, legal, or tax advice.">
      ...
      <section><h2>Verify before signing</h2><p>Always verify the destination, SOL amount, PWRC mint, token fee, network, program, and wallet prompt before approving a transaction. Solana network fees are separate from the PWRC Token-2022 fee. Do not sign a transaction you do not understand.</p></section>
